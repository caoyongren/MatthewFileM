...
public class FileIconLoader implements Callback {
     ...
     */
    private final static ConcurrentHashMap<String, ImageHolder> mImageCache
    ...
    public boolean loadIcon(ImageView view, String path, long id,
                            FileCategoryHelper.FileCategory cate) {
    ...
    public long getDbId(String path, boolean isVideo) {
        ...
        Uri uri = isVideo ?
                  Video.Media.getContentUri(volumeName) : Images.Media.getContentUri(volumeName);
                ...
                if (holder != null && holder.state == ImageHolder.NEEDED) {
                    ...
                    switch (id.mCategory) {
                        ...
                        case Video:
                            ...
                            holder.setImage(isVideo ?
                                            getVideoThumbnail(id.mId) : getImageThumbnail(id.mId));
                            break;
                    }
